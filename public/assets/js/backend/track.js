define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'track/index' + location.search,
                    add_url: 'track/add',
                    edit_url: 'track/edit',
                    del_url: 'track/del',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'device', title: __('Device')},
                        {field: 'osver', title: __('Osver')},
                        {field: 'apkver', title: __('Apkver')},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'track/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
